            ...
            return i(t, e), x(t, [{
                ...
                key: "handleVoteSubmit", value: function (e, t) {
                    ...
                    Object(y.a)(i).then(function (e) {
                        ...
                        401 === e.status ? n.props.handleLogout("/login", "error", "You have been logged out. Please login to vote") : h.a.error({
                            message: "Polling App",
                ...
                key: "render", value: function () {
                    ...
                    }, v.a.createElement(f.a, {type: "plus"}), " Load more")), this.state.isLoading ? v.a.createElement(b.a, null) : null)
                }
            }]), t
        }(m.Component);
    t.a = Object(C.f)(E)
        ...
        O = n(434), x = n(455), E = n(176), _ = n(96), P = n(478), k = function () {
            ...
            return i(t, e), k(t, [{
                ...
                key: "handleLogout", value: function () {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "/",
                        t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "success",
                        n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "You're successfully logged out.";
                    localStorage.removeItem(y.a), this.setState({
                        currentUser: null,
                        isAuthenticated: !1
                    }), this.props.history.push(e), f.a[t]({message: "Polling App", description: n})
                }
            }, {
            ...
            return a(t, e), F(t, [{
                ...
                key: "handleSubmit", value: function (e) {
                    ...
                    Object(M.d)(n).then(function (e) {
                        ...
                        401 === e.status ? t.props.handleLogout("/login", "error", "You have been logged out. Please login create poll.") : T.a.error({
                            message: "Polling App",
                            description: e.message || "Sorry! Something went wrong. Please try again!"
                        })
                    })
                ...
                key: "render", value: function () {
                    ...
                    }), N.a.createElement("div", {className: "new-poll-container"}, N.a.createElement("h1", {className: "page-title"}, "Create Poll"), N.a.createElement("div", {className: "new-poll-content"}, N.a.createElement(v.a, {
                    ...
                    }, N.a.createElement(c.a, {type: "plus"}), " Add a choice")), N.a.createElement(I, {className: "poll-form-row"}, N.a.createElement(O.a, {
                        xs: 24,
                        sm: 4
        ...
        w = n.n(b), C = n(0), O = n.n(C), x = n(37), E = n(431), _ = (n.n(E), n(23)), P = n(45), k = function () {
            ...
            return i(t, e), k(t, [{
                ...
                key: "render", value: function () {
                    ...
                    }, "Login"), "Or ", O.a.createElement(_.b, {to: "/signup"}, "register now!")))
                }
            }]), t
        }(C.Component);
    t.a = S
        ...
        O = n(433), x = (n.n(O), n(23)), E = n(45), _ = function () {
            ...
            function t(e) {
                ...
                return n.validateName = function (e) {
                    return e.length < E.f ? {
                        validateStatus: "error",
                        errorMsg: "Name is too short (Minimum " + E.f + " characters needed.)"
                    } : e.length > E.e ? {
                        validationStatus: "error",
                        errorMsg: "Name is too long (Maximum " + E.e + " characters allowed.)"
                    } : {validateStatus: "success", errorMsg: null}
                }, n.validateEmail = function (e) {
                    return e ? RegExp("[^@ ]+@[^@ ]+\\.[^@ ]+").test(e) ? e.length > E.c ? {
                        validateStatus: "error",
                        errorMsg: "Email is too long (Maximum " + E.c + " characters allowed)"
                    } : {validateStatus: null, errorMsg: null} : {
                        validateStatus: "error",
                        errorMsg: "Email not valid"
                    } : {validateStatus: "error", errorMsg: "Email may not be empty"}
                }, n.validateUsername = function (e) {
                    return e.length < E.m ? {
                        validateStatus: "error",
                        errorMsg: "Username is too short (Minimum " + E.m + " characters needed.)"
                    } : e.length > E.l ? {
                        validationStatus: "error",
                        errorMsg: "Username is too long (Maximum " + E.l + " characters allowed.)"
                    } : {validateStatus: null, errorMsg: null}
                }, n.validatePassword = function (e) {
                    return e.length < E.h ? {
                        validateStatus: "error",
                        errorMsg: "Password is too short (Minimum " + E.h + " characters needed.)"
                    } : e.length > E.g ? {
                        validationStatus: "error",
                        errorMsg: "Password is too long (Maximum " + E.g + " characters allowed.)"
                    } : {validateStatus: "success", errorMsg: null}
                }, n.state = {
                    name: {value: ""},
                    username: {value: ""},
            ...
            return a(t, e), _(t, [{
                ...
                key: "render", value: function () {
                    var e = this;
                    return w.a.createElement("div", {className: "signup-container"}, w.a.createElement("h1", {className: "page-title"}, "Sign Up"), w.a.createElement("div", {className: "signup-content"}, w.a.createElement(u.a, {
                        onSubmit: this.handleSubmit,
                        ...
                        disabled: this.isFormInvalid()
                    }, "Sign up"), "Already registed? ", w.a.createElement(x.b, {to: "/login"}, "Login now!")))))
                }
            }, {
